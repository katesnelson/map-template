...
L.mapbox.accessToken =
	'pk.eyJ1Ijoia2F0ZXNuZWxzb24iLCJhIjoiY2l0NGhiemNqMDBiZDd3bGVuMHFyZHVscyJ9.H2hZ9ZzYxHMKSc7CigNaqQ';
...
var map = L.mapbox.map('map', "katesnelson.1f9623hp").setView([42.416634, -71.104760],
	10);//this the resoltuion in meters per pixel z number at end of googlemaps url
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 
	$.getJSON('https://katesnelson.cloudant.com/kate/_design/tour/',
		function(result) {
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 	
	var cloudantURLbase =
		"'https://katesnelson.cloudant.com/kate/_design/tour/_search/ids?q=";
	var cloudantURLcallback = "&callback=?";
